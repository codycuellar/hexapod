...
class Leg:
    ...
    def __init__(self, coxa: ServoConfig, femur: ServoConfig, tibia: ServoConfig, coxa_len=50, femur_len=50, tibia_len=50):
        """
    ...
    def _calculate_ik(self, x, y, z):
        ...
        xyH = max(0, math.sqrt(y**2 + x**2) - self.coxa_len)
        zH = math.sqrt(z**2 + xyH**2)
        z_theta = math.atan2(z, xyH)
    ...
    def _normalize_relative_angles(self, a1, a2, a3):
        ...
        tibia_angle = a3 - self.tibia_config.zeroed_angle if not self.tibia_config.inverted else self.tibia_config.zeroed_angle - a3
